...
function ForgotPassword() {
    ...
    const handleSendOTP = async () => {
        try {
            const res = await axios.post(`${port}/sendotp`, { email });
    ...
    const handleVerifyOTP = async () => {
        try {
            const res = await axios.post(`${port}/verifyotpcheck`, { email, otp }); // new route for checking otp
    ...
    const handleResetPassword = async () => {
        try {
            const res = await axios.post(`${port}/verifyotp`, { email, otp, newPassword });
