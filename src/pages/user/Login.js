...
function Login() {
    ...
    useEffect(() => {
        axios.get(`${port}/auth/user`, { withCredentials: true })
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`${port}/checkusers`, loginInfo);
    ...
    const handleGoogleLogin = async (credentialResponse) => {
        try {
            const response = await axios.post(`${port}/auth/google/verify`, {
