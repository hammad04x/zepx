...
function Products() {
  ...
  const getProductsByCategory = async (categoryId) => {
    try {
      setLoading(true);
      const res = await axios.get(`${port}/getproductsbycategoryid/${categoryId}?page=${page}&limit=4`);
  ...
  const getAllProducts = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`${port}/getpaginatedproducts?page=${page}&limit=4`);
  ...
  const getCategoryName = async (categoryId) => {
    try {
      const res = await axios.get(`${port}/getcategorybyid/${categoryId}`);
  ...
  const handleSearch = async () => {
    ...
    try {
      setLoading(true);
      const res = await axios.get(`${port}/searchproducts?term=${searchTerm}`);
